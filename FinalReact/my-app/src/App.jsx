...
function App() {
    ...
    React.useEffect(() => {
        ...
        async function axiosData(){
            ...
            const tyrsData = await axios.get('https://639779e286d04c763396a358.mockapi.io/tyrs')
            const cartData = await axios.get('https://639779e286d04c763396a358.mockapi.io/cart')
            const favoritesData = await axios.get('https://639779e286d04c763396a358.mockapi.io/favorites')
    ...
    const deleteItems=(id)=>{
        console.log(id);
        axios.delete(`https://639779e286d04c763396a358.mockapi.io/cart/${id}`)
